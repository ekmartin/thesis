...
datasets. Without it, Soup's capabilities would be capped at the memory size of
...
libraries. Note that the call to \code{rand} in listing~\ref{lst:extern} needs
...
pub extern "C" fn multiply(a: i32, b: i32) -> i32 {
  ...
  \end{minted}
  \caption{\
    The \code{multiply} functions can be called through the C-calling
    convention by other programs. The \code{no\_mangle} ensures the
    \code{multiply} name stays unmodified by the compiler.
