...
\begin{abstract}
  ...
  traditional database systems. Soup is a new and highly scalable system
...
threads, maintaining high read performance even in the midst of processing a
...
up the recovery performance by avoiding having to process a potentially large
...
\begin{figure}[H]
  ...
  \caption{
    The two graphs, both with logarithmic axis, show the initial and total
    recovery time for recovery based on only log entries, and only snapshots.
  }
\end{figure}
