...
\begin{itemize}
  ...
  \item \textbf{Chapter~\ref{chap:future-work}} presents possible next steps
  towards a production-ready and durable Soup.
  \item \textbf{Chapter~\ref{chap:conclusion}} TODO
\end{itemize}
